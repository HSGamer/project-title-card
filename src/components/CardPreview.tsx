...
export const CardPreview: FunctionalComponent<CardPreviewProps> = ({
  ...
  return (
    ...
    >
      {/* Header: Title, Dimension Badge, and Copy Button (Always 1 single clean line) */}
      <div class="flex justify-between items-center gap-2 mb-2.5 pb-2.5 border-b border-base-300">
      ...
      {/* Toolbar: Backdrop Switcher on left, Zoom Controls on right (Always 1 single clean line) */}
      <div class="flex justify-between items-center gap-1.5 mb-2.5 w-full">
        {/* Backdrop Switcher */}
        <div class="join shrink-0">
          <div class="tooltip tooltip-bottom" data-tip="Checkerboard">
            <button
              type="button"
